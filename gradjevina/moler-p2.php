...
<body>
    ...
    $result = $conn->query("SELECT * FROM test WHERE id>=7 and id<=7*2")
        or die($conn->error);
    ?>
    <!--#region Modal -->
                                ...
                                <td colspan="2" class="page">
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination justify-content-md-end justify-content-center">
                                            <li class="page-item"><a class="page-link  fs-5" href="./moler.php">Nazad</a></li>
                                            <li class="page-item"><a class="page-link  fs-5" href="./moler.php">1</a>
                                            </li>
                                            <li class="page-item"><a class="page-link active fs-5" href="./moler-p2.php">2</a>
                                            </li>
                                            <li class="page-item"><a class="page-link  fs-5" href="./moler-p3.php">3</a>
                                            </li>
                                            <li class="page-item"><a class="page-link  fs-5" href="./moler-p3.php">Napred</a>
                                            </li>
                                        </ul>
                                    </nav>
                                </td>
