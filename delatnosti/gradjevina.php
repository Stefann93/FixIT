...
if (isset($_GET['logout'])) {
    ...
    header("Location: gradjevina.php");
}
?>
...
<body>
                ...
                <div class="modal-body">
                    ...
                    <div class="myform bg-dark radius-register">
                        <div class="row">
                            ...
                            <div class="col">
                                <form action="gradjevina.php" method="post">
                ...
                <ul class="navbar-nav ms-auto text-uppercase">
                    ...
                    <li class="nav-item dropdown account-drop me-lg-5">
                        ...
                        <ul class="dropdown-menu text-center bg-dark text-white">
                            ...
                            <li><a href="gradjevina.php?logout=true" class="dropdown-item hover-element text-white <?php
                                                                                                                    if (!isset($_SESSION['korisnik']) && !isset($_SESSION['fizicko lice']) && !isset($_SESSION['firma']) && (!isset($_COOKIE['email']) && !isset($_COOKIE['sifra']))) {
                                                                                                                        echo 'd-none';
                                                                                                                    }
                                                                                                                    ?>">Odjavi se</a></li>
    ...
    <nav class="sidebar">
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                <a href="../delatnosti/odrzavanje.php" class="sidebar-link">
    ...
    <main class="container pt-5 ps-md-5">
        <section>
            <div class="row justify-content-center justify-content-md-start">
                <h1 class="text-center text-sm-start">GRAĐEVINA</h1>
                <a href="../posao.php?posao=moler&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GRADJEVINSKI-RADOVI/MOLER.jpg');">
                    <span>Moler</span>
                </a>
                <a href="../posao.php?posao=gipsar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GRADJEVINSKI-RADOVI/GIPSAR.jpg');">
                    <span>Gipsar</span>
                </a>
                <a href="../posao.php?posao=fasader&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GRADJEVINSKI-RADOVI/FASADER.jpg');">
                    <span>Fasader</span>
                </a>
                <a href="../posao.php?posao=zidar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GRADJEVINSKI-RADOVI/ZIDAR.jpg');">
                    <span>Zidar</span>
                </a>
                <a href="../posao.php?posao=parketar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GRADJEVINSKI-RADOVI/PARKETAR.jpg');">
                    <span>Parketar</span>
                </a>
                <a href="../posao.php?posao=keramicar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GRADJEVINSKI-RADOVI/KERAMICAR.jpg');">
                    <span>Keramičar</span>
                </a>
                <a href="../posao.php?posao=limar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GRADJEVINSKI-RADOVI/LIMAR.jpg');">
                    <span>Limar</span>
                </a>
                <a href="../posao.php?posao=varilac&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GRADJEVINSKI-RADOVI/VARILAC.jpg');">
                    <span>Varilac</span>
                </a> <a href="../posao.php?posao=stolar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GRADJEVINSKI-RADOVI/STOLAR.jpg');">
                    <span>Stolar</span>
                </a>
                <a href="../posao.php?posao=izloater&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GRADJEVINSKI-RADOVI/IZOLATER.jpg');">
                    <span>Izolater</span>
                </a>
                <a href="../posao.php?posao=tesar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GRADJEVINSKI-RADOVI/TESAR.jpg');">
                    <span>Tesar</span>
                </a>
                <a href="../posao.php?posao=banzeni%20i%20fonatne&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GRADJEVINSKI-RADOVI/IZRADABAZENA.jpg');">
                    <span>Bazeni i fontane</span>
                </a> <a href="../posao.php?posao=pomocni%20radnik&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GRADJEVINSKI-RADOVI/POMOCNIRADNIK.jpg');">
                    <span>Pomoćni radnik</span>
                </a>
                <a href="../posao.php?posao=podne%20povrsine&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GRADJEVINSKI-RADOVI/PODNEPOVRSINE.jpg ');">
                    <span>Podne površine</span>
                </a>
                <a href="../posao.php?posao=secenje%20i%20busenje&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GRADJEVINSKI-RADOVI/SECENJEIBUSENJE.jpg');">
                    <span>Sečenje i bušenje</span>
                </a>
                <a href="../posao.php?posao=armirac&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GRADJEVINSKI-RADOVI/ARMIRAC.jpg');">
                    <span>Armirač</span>
                </a><a href="../posao.php?posao=bravar-monter&p=1" class="col-6 col-lg-3 mx-2 mt-3 mb-5 slikaPosla" style="background-image: url('../slike/Delatnosti/GRADJEVINSKI-RADOVI/BRAVARMONTER.jpg');">
                    <span>Bravar-monter</span>
                </a>
            </div>
        </section>
    </main>
