...
if (isset($_GET['logout'])) {
    ...
    header("Location: obrada-materijala.php");
}
?>
                ...
                <div class="modal-body">
                    ...
                    <div class="myform bg-dark radius-register">
                        <div class="row">
                            ...
                            <div class="col">
                                <form action="obrada-materijala.php" method="post">
                ...
                <ul class="navbar-nav ms-auto text-uppercase">
                    ...
                    <li class="nav-item dropdown account-drop me-lg-5">
                        ...
                        <ul class="dropdown-menu text-center bg-dark text-white">
                            ...
                            <li><a href="obrada-materijala.php?logout=true" class="dropdown-item hover-element text-white <?php
                                                                                                                            if (!isset($_SESSION['korisnik']) && !isset($_SESSION['fizicko lice']) && !isset($_SESSION['firma']) && (!isset($_COOKIE['email']) && !isset($_COOKIE['sifra']))) {
                                                                                                                                echo 'd-none';
                                                                                                                            }
                                                                                                                            ?>">Odjavi se</a></li>
    ...
    <main class="container pt-5 ps-md-5">
        <section>
            <div class="row justify-content-center justify-content-md-start">
                <h1 class="text-center text-sm-start">OBRADA MATERIJALA</h1>
                <a href="../posao.php?posao=klucar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/OBRADA-MATERIJALA/KLJUCAR.jpg');">
                    <span>Ključar</span>
                </a>
                <a href="../posao.php?posao=tapetar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/OBRADA-MATERIJALA/TAPETAR.jpg');">
                    <span>Tapetar</span>
                </a>
                <a href="../posao.php?posao=metalostrugar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/OBRADA-MATERIJALA/METALOSTRUGAR.jpg');">
                    <span>Metalostrugar</span>
                </a>
                <a href="../posao.php?posao=stolar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/OBRADA-MATERIJALA/STOLAR.jpg');">
                    <span>Stolar</span>
                </a>
                <a href="../posao.php?posao=staklorezac&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/OBRADA-MATERIJALA/STAKLOREZAC.jpg');">
                    <span>Staklorezac</span>
                </a>
                <a href="../posao.php?posao=grncar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/OBRADA-MATERIJALA/GRNCAR.jpg');">
                    <span>Grnčar</span>
                </a>
                <a href="../posao.php?posao=kamenorezac&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/OBRADA-MATERIJALA/KAMENOREZAC.jpg');">
                    <span>Kamenorezac</span>
                </a>
                <a href="../posao.php?posao=masin-bravar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/OBRADA-MATERIJALA/MASINBRAVAR.jpg');">
                    <span>Mašin-bravar</span>
                </a> <a href="../posao.php?posao=kovac&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/OBRADA-MATERIJALA/KOVAC.jpg');">
                    <span>Kovač</span>
                </a>
                <a href="../posao.php?posao=povrsinska%20obrada&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/OBRADA-MATERIJALA/POVRSINSKAOBRADA.jpg');">
                    <span>Površinska obrada</span>
                </a>
                <a href="../posao.php?posao=livac&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/OBRADA-MATERIJALA/LIVAC.jpg');">
                    <span>Livač</span>
                </a>
                <a href="../posao.php?posao=uramljivac&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/OBRADA-MATERIJALA/URAMLJIVAC.jpg');">
                    <span>Uramljivač</span>
                </a> <a href="../posao.php?posao=metaloglodac&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/OBRADA-MATERIJALA/METALOGLODAC.jpg');">
                    <span>Metaloglodač</span>
                </a>
                <a href="../posao.php?posao=metaloostrac&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/OBRADA-MATERIJALA/METALOOSTRAC.jpg');">
                    <span>Metalooštrač</span>
                </a>
                <a href="../posao.php?posao=pecatorezac&p=1" class="col-6 col-lg-3 mx-2 mt-3 mb-5 slikaPosla" style="background-image: url('../slike/Delatnosti/OBRADA-MATERIJALA/PECATOREZAC.jpg');">
                    <span>Pečatorezac</span>
                </a>
            </div>
        </section>
    </main>
