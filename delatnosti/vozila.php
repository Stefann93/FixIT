                ...
                <ul class="navbar-nav ms-auto text-uppercase">
                    ...
                    <li class="nav-item dropdown account-drop me-lg-5">
                        ...
                        <ul class="dropdown-menu text-center bg-dark text-white">
                            ...
                            <li><a href="vozila.php?logout=true" class="dropdown-item hover-element text-white <?php
                                                                                                                if (!isset($_SESSION['korisnik']) && !isset($_SESSION['fizicko lice']) && !isset($_SESSION['firma']) && (!isset($_COOKIE['email']) && !isset($_COOKIE['sifra']))) {
                                                                                                                    echo 'd-none';
                                                                                                                }
                                                                                                                ?>">Odjavi se</a></li>
    ...
    <main class="container pt-5 ps-md-5">
        <section>
            <div class="row justify-content-center justify-content-md-start">
                <h1 class="text-center text-sm-start">ODRŽAVANJE VOZILA</h1>
                ...
                <a href="../posao.php?posao=auto%20bravar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/ODRZAVANJE-VOZILA/AUTOBRAVAR.jpg');">
                    <span>Auto bravar</span>
                </a>
                <a href="../posao.php?posao=auto%20mehanicar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/ODRZAVANJE-VOZILA/AUTOMEHANICAR.jpg');">
                    <span>Auto mehaničar</span>
                </a>
                <a href="../posao.php?posao=serviser%20autogas%20sistema&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/ODRZAVANJE-VOZILA/SERVISERGASNIHSISTEMA.jpg');">
                    <span>Serviser autogas sistema</span>
                </a>
                <a href="../posao.php?posao=auto%20graficar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/ODRZAVANJE-VOZILA/AUTOGRAFICAR.jpg');">
                    <span>Auto grafičar</span>
                </a>
                <a href="../posao.php?posao=auto%20tapetar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/ODRZAVANJE-VOZILA/AUTOTAPETAR.jpg');">
                    <span>Auto tapetar</span>
                </a>
                <a href="../posao.php?posao=auto%20perac&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/ODRZAVANJE-VOZILA/AUTOPERAC.jpg');">
                    <span>Auto perač</span>
                </a> <a href="../posao.php?posao=Vulkanizer&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/ODRZAVANJE-VOZILA/VULKANIZER.jpg');">
                    <span>Vulkanizer</span>
                </a>
                <a href="../posao.php?posao=slep%20sluzba&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/ODRZAVANJE-VOZILA/SLEPSLUZBA.jpg');">
                    <span>Šlep služba</span>
                </a>
                <a href="../posao.php?posao=serviser%20trapa&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/ODRZAVANJE-VOZILA/SERVISERTRAPA.jpg');">
                    <span>Serviser trapa</span>
                </a>
                <a href="../posao.php?posao=auto%20stakla&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/ODRZAVANJE-VOZILA/AUTOSTAKLA.jpg');">
                    <span>Auto stakla</span>
                </a> <a href="../posao.php?posao=auto%20plasticar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/ODRZAVANJE-VOZILA/AUTOPLASTICAR.jpg');">
                    <span>Auto plastičar</span>
                </a>
                <a href="../posao.php?posao=serviser%20auspuha&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/ODRZAVANJE-VOZILA/AUSPUH.jpg');">
                    <span>Serviser auspuha</span>
                </a>
                <a href="../posao.php?posao=serviser%20motocikala&p=1" class="col-6 col-lg-3 mx-2 mt-3 mb-5 slikaPosla" style="background-image: url('../slike/Delatnosti/ODRZAVANJE-VOZILA/MOTOCIKLI.jpg');">
                    <span>Serviser motocikala</span>
                </a>
            </div>
        </section>
    </main>
