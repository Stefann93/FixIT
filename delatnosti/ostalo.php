                ...
                <div class="modal-body">
                    ...
                    <div class="myform bg-dark radius-register">
                        <div class="row">
                            ...
                            <div class="col">
                                <form action="ostalo.php" method="post">
                ...
                <ul class="navbar-nav ms-auto text-uppercase">
                    ...
                    <li class="nav-item dropdown account-drop me-lg-5">
                        ...
                        <ul class="dropdown-menu text-center bg-dark text-white">
                            ...
                            <li><a href="ostalo.php?logout=true" class="dropdown-item hover-element text-white <?php
                                                                                                                if (!isset($_SESSION['korisnik']) && !isset($_SESSION['fizicko lice']) && !isset($_SESSION['firma']) && (!isset($_COOKIE['email']) && !isset($_COOKIE['sifra']))) {
                                                                                                                    echo 'd-none';
                                                                                                                }
                                                                                                                ?>">Odjavi se</a></li>
    ...
    <main class="container pt-5 ps-md-5">
        <section>
            <div class="row justify-content-center justify-content-md-start">
                <h1 class="text-center text-sm-start">OSTALO</h1>
                <a href="../posao.php?posao=vozac&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/NEKATEGORIZOVANO/VOZAC.jpg');">
                    <span>Vozač</span>
                </a>
                <a href="../posao.php?posao=transport%20selidbe&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/NEKATEGORIZOVANO/TRANSPORT.jpg');">
                    <span>Transport selidbe</span>
                </a>
                <a href="../posao.php?posao=fizicki%20radnik&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/NEKATEGORIZOVANO/FIZICKIRADNIK.jpg');">
                    <span>Fizički radnik</span>
                </a>
                <a href="../posao.php?posao=ikonopisac&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/NEKATEGORIZOVANO/IKONOPISAC.jpg');">
                    <span>Ikonopisac</span>
                </a>
                <a href="../posao.php?posao=serviser%20za%20bicikle&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/NEKATEGORIZOVANO/SERVISERBICIKALA.jpg');">
                    <span>Serviser za bicikle</span>
                </a>
                <a href="../posao.php?posao=ski%20serviser&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/NEKATEGORIZOVANO/SKISERVISER.jpg');">
                    <span>Ski serviser</span>
                </a>
                <a href="../posao.php?posao=serviser%20medicinske%20opreme&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/NEKATEGORIZOVANO/SERVISRMEDICINSKEOPREME.jpg');">
                    <span>Serviser medicinske opreme</span>
                </a>
                <a href="../posao.php?posao=roletne%20i%20venecijaneri&p=1" class="col-6 col-lg-3 mx-2 mt-3 mb-5 slikaPosla" style="background-image: url('../slike/Delatnosti/NEKATEGORIZOVANO/VENECIJANERI.jpg');">
                    <span>Roletne i venecijaneri</span>
                </a>
            </div>
        </section>
    </main>
    <!--#region Footer-->
    <footer class="p-4 bg-dark text-white text-center position-relative" style="bottom:-323px">
        <div class="container">
