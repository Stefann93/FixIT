...
if (isset($_GET['logout'])) {
    ...
    header("Location: cevne-instalacije.php");
}
?>
                ...
                <div class="modal-body">
                    ...
                    <div class="myform bg-dark radius-register">
                        <div class="row">
                            ...
                            <div class="col">
                                <form action="cevne-instalacije.php" method="post">
    ...
    <nav class="sidebar">
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item" id="a">
                <a href="../delatnosti/cevne-instalacije.php" class="sidebar-link selected">
    ...
    <main class="container pt-5 ps-md-5">
        <section>
            <div class="row justify-content-center justify-content-md-start">
                <h1 class="text-center text-sm-start">CEVNE INSTALACIJE</h1>
                <a href="../posao.php?posao=vodoinstalater&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/CEVNE-INSTALACIJE/VODOINSTALATER.jpg');">
                    <span>Vodoinstalater</span>
                </a>
                <a href="../posao.php?posao=monter%20grejnih%20instalacija&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/CEVNE-INSTALACIJE/GREJANJE.jpg');">
                    <span>Monter grejnih instalacija</span>
                </a>
                <a href="../posao.php?posao=ventilacioni%20sistemi&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/CEVNE-INSTALACIJE/VENTILACIONISISTEMI.jpg');">
                    <span>Ventilacioni sistemi</span>
                </a>
            </div>
        </section>
    </main>
    <!--#region Footer-->
    <footer class="p-4 bg-dark text-white text-center position-relative" style="bottom: -500px;">
        <div class="container">
