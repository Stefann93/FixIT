...
<body>
                ...
                <div class="modal-body">
                    ...
                    <div class="myform bg-dark radius-register">
                        <div class="row">
                            ...
                            <div class="col">
                                <form action="garderoba.php" method="post">
                ...
                <ul class="navbar-nav ms-auto text-uppercase">
                    ...
                    <li class="nav-item dropdown account-drop me-lg-5">
                        ...
                        <ul class="dropdown-menu text-center bg-dark text-white">
                            ...
                            <li><a href="garderoba.php?logout=true" class="dropdown-item hover-element text-white <?php
                                                                                                                    if (!isset($_SESSION['korisnik']) && !isset($_SESSION['fizicko lice']) && !isset($_SESSION['firma']) && (!isset($_COOKIE['email']) && !isset($_COOKIE['sifra']))) {
                                                                                                                        echo 'd-none';
                                                                                                                    }
                                                                                                                    ?>">Odjavi se</a></li>
    ...
    <main class="container pt-5 ps-md-5">
        <section>
            <div class="row justify-content-center justify-content-md-start">
                <h1 class="text-center text-sm-start px-5">GARDEROBA I NAKIT</h1>
                <a href="../posao.php?posao=krojac&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GARDEROBAINAKIT/KROJAC.jpg');">
                    <span>Krojač</span>
                </a>
                <a href="../posao.php?posao=obucar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GARDEROBAINAKIT/OBUCAR.jpg');">
                    <span>Obućar</span>
                </a>
                <a href="../posao.php?posao=tasner&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GARDEROBAINAKIT/TASNER.jpg');">
                    <span>Tašner</span>
                </a>
                <a href="../posao.php?posao=sajdzija%20-%20casovnicar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GARDEROBAINAKIT/CASOVNICAR.jpg');">
                    <span>Sajdžija - Časovnicar</span>
                </a>
                <a href="../posao.php?posao=zlatar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GARDEROBAINAKIT/ZLATAR.jpg');">
                    <span>Zlatar</span>
                </a>
                <a href="../posao.php?posao=masinski%20vez&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GARDEROBAINAKIT/MASINSKIVEZ.jpg');">
                    <span>Mašinski vez</span>
                </a>
                <a href="../posao.php?posao=rucni%20vez&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GARDEROBAINAKIT/RUCNIVEZ.jpg');">
                    <span>Ručni vez</span>
                </a>
                <a href="../posao.php?posao=krznar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GARDEROBAINAKIT/KRZNAR.jpg');">
                    <span>Krznar</span>
                </a> <a href="../posao.php?posao=sesirdzija&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/GARDEROBAINAKIT/SESIRDZIJA.jpg');">
                    <span>Šeširdžija</span>
                </a>
                <a href="../posao.php?posao=serviser%20sivacih%20masina&p=1" class="col-6 col-lg-3 mx-2 mt-3 mb-5 slikaPosla" style="background-image: url('../slike/Delatnosti/GARDEROBAINAKIT/SERVISERSIVECIHMASINA.jpg');">
                    <span>Serviser šivaćih mašina</span>
                </a>
            </div>
        </section>
    </main>
    ...
    <!--#region Footer-->
    <footer class="p-4 bg-dark text-white text-center position-relative" style="bottom: -50px;">
        <div class="container">
