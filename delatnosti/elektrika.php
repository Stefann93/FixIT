                ...
                <div class="modal-body">
                    ...
                    <div class="myform bg-dark radius-register">
                        <div class="row">
                            ...
                            <div class="col">
                                <form action="elektrika.php" method="post">
                ...
                <ul class="navbar-nav ms-auto text-uppercase">
                    ...
                    <li class="nav-item dropdown account-drop me-lg-5">
                        ...
                        <ul class="dropdown-menu text-center bg-dark text-white">
                            ...
                            <li><a href="elektrika.php?logout=true" class="dropdown-item hover-element text-white <?php
                                                                                                                    if (!isset($_SESSION['korisnik']) && !isset($_SESSION['fizicko lice']) && !isset($_SESSION['firma']) && (!isset($_COOKIE['email']) && !isset($_COOKIE['sifra']))) {
                                                                                                                        echo 'd-none';
                                                                                                                    }
                                                                                                                    ?>">Odjavi se</a></li>
    ...
    <main class="container pt-5 ps-md-5">
        <section>
            <div class="row justify-content-center justify-content-md-start">
                <h1 class="text-center text-sm-start">ELEKTRIKA</h1>
                <a href="../posao.php?posao=elektricar&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/ELEKTRIKA/ELEKTRICAR.jpg');">
                    <span class="Dugnaziv">Električar</span>
                </a>
                <a href="../posao.php?posao=vikler%20elektromotora&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/ELEKTRIKA/VIKLER.jpg');">
                    <span class="Dugnaziv">Vikler elektromotora</span>
                </a>
                <a href="../posao.php?posao=Serviser%20liftova&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/ELEKTRIKA/SERVISLIFTOVA.jpg');">
                    <span class="naziv">Serviser liftova</span>
                </a>
                <a href="../posao.php?posao=Monter%20klima%20uredjaja&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/ELEKTRIKA/MONTERKLIMA.jpg');">
                    <span class="Dugnaziv">Monter klima uređaja</span>
                </a>
                <a href="../posao.php?posao=Audio-video%20serviser&p=1" class="col-6 col-lg-3 mx-2 mt-3 slikaPosla" style="background-image: url('../slike/Delatnosti/ELEKTRIKA/AUDIOVIDEO.jpg');">
                    <span class="Dugnaziv">Audio-video serviser</span>
                </a>
