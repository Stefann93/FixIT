            ...
            <div class="tab-content mb-5">
                ...
                <div id="recenzije" data-tab-content>
                    <div class="d-lg-flex justify-content-between flex-wrap">
                        <div class="recenzije">
                            ...
                            <p class="lead posebne-ocene d-block d-sm-flex justify-content-between"><span
                                    class="kvalitet-usluga"></span>Kvalitet
                                Usluge<span class="wrapper"><span class="bar"
                                        style="background-color: #CBE8DA;"></span><span class="fw-bold">10</span></span>
                            </p>
                            <p class="lead posebne-ocene d-block d-sm-flex justify-content-between"><span
                                    class="postovanje-rokova"></span>Postovanje
                                rokova<span class="wrapper"><span class="bar"
                                        style="background-color: #c0d4e4;"></span><span class="fw-bold">10</span></span>
                            </p>
                            <p class="lead posebne-ocene d-block d-sm-flex justify-content-between"><span
                                    class="povoljnost-cena"></span>Povoljnost
                                cena<span class="wrapper"><span class="bar"
                                        style="background-color: #beb4d6;"></span><span class="fw-bold">10</span></span>
                            </p>
                            <p class="lead posebne-ocene d-block d-sm-flex pb-4 justify-content-between"><span
                                    class="odnos"></span>Odnos
                                prema
                                korisniku
                                usluga<span class="wrapper"><span class="bar"
                                        style="background-color: #d194c3;"></span><span class="fw-bold">10</span></span>
                            </p>
                        </div>
                    ...
                    <div class="komentari mt-3 pb-4">
                        <h4><span class="korisnik"></span>
                            ...
                            <span class="wrapper-komentar">
                                <span class="kvalitet-usluga-kruzic">10</span><span
                                    class="postovanje-rokova-kruzic mx-2">10</span><span
                                    class="povoljnost-cena-kruzic">10</span><span
                                    class="odnos-kruzic mx-2">10</span></span>
                        </h4>
                ...
                <div id="kontakt" data-tab-content>
                    ...
                    <div class="ostatak-sekcija mt-3 pb-4">
                        ...
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d22791.426697029554!2d20.691289773867474!3d44.434632202799015!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4750bac18302ae3f%3A0xc6c85658f278872!2z0JzQu9Cw0LTQtdC90L7QstCw0YY!5e0!3m2!1ssr!2srs!4v1673096595731!5m2!1ssr!2srs"
                ...
                <div id="angazovanje" data-tab-content>
                    ...
                    <div class="ostatak-sekcija mt-3">
                        ...
                        <p class="lead undertext">Opisite majstoru ukratko vas razlog angazovanja, kvar ili posao koji
                            treba
                            obaviti</p>
                        <textarea name="opis" class="opis-tekst  mb-4" id="opis" rows="7"
                            placeholder="Type..."></textarea>
                    </div>
                    <div class="text-center">
                        <button type="button" class="prijavi-button btn btn-primary text-white py-2 mt-4 fs-4"
                            onclick="Angazovanje()">ANGAZUJ</button>
                    </div>
                </div>
            </div>
        </div>
