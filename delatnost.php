...
<body>
    ...
    <nav class="sidebar">
        <ul class="sidebar-nav">
            <li class="sidebar-item" id="a">
                <a href="./delatnost.php?delatnost=gradjevinski-radovi" class="sidebar-link <?php if (isset($_GET['delatnost']) && $_GET['delatnost'] === 'gradjevinski-radovi') echo 'selected'; ?>">
                    <img src="./slike/Ikonice/Poslovi(White)/GRADJEVINA2.svg" alt="" class="img-fluid ikonice" />
                    <span class="link-text">Građevina</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a href="./delatnost.php?delatnost=elektrika" class="sidebar-link <?php if (isset($_GET['delatnost']) && $_GET['delatnost'] === 'elektrika') echo 'selected'; ?>">
                    <img src="./slike/Ikonice/Poslovi(White)/ELEKTRONIKA2.svg" alt="" class="img-fluid ikonice" />
                    <span class="link-text">Elektrika</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a href="./delatnost.php?delatnost=odrzavanje" class="sidebar-link <?php if (isset($_GET['delatnost']) && $_GET['delatnost'] === 'odrzavanje') echo 'selected'; ?>">
                    <img src="./slike/Ikonice/Poslovi(White)/ODRZAVANJE2.svg" alt="" class="img-fluid ikonice" />
                    <span class="link-text">Održavanje</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a href="./delatnost.php?delatnost=cevne-instalacije" class="sidebar-link <?php if (isset($_GET['delatnost']) && $_GET['delatnost'] === 'cevne-instalacije') echo 'selected'; ?>">
            ...
            <li class="sidebar-item">
                <a href="./delatnost.php?delatnost=obrada-materijala" class="sidebar-link <?php if (isset($_GET['delatnost']) && $_GET['delatnost'] === 'obrada-materijala') echo 'selected'; ?>">
                    <img src="./slike/Ikonice/Poslovi(White)/OBRADA2.svg" alt="" class="img-fluid ikonice" />
                    <span class="link-text">Obrada materijala</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a href="./delatnost.php?delatnost=odrzavanje-vozila" class="sidebar-link <?php if (isset($_GET['delatnost']) && $_GET['delatnost'] === 'odrzavanje-vozila') echo 'selected'; ?>">
                    <img src="./slike/Ikonice/Poslovi(White)/VOZILA2.svg" alt="" class="img-fluid ikonice" />
                    <span class="link-text">Održavanje vozila</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a href="./delatnost.php?delatnost=garderoba-i-nakit" class="sidebar-link <?php if (isset($_GET['delatnost']) && $_GET['delatnost'] === 'garderoba-i-nakit') echo 'selected'; ?>">
            ...
            <li class="sidebar-item">
                <a href="./delatnost.php?delatnost=ostalo" class="sidebar-link <?php if (isset($_GET['delatnost']) && $_GET['delatnost'] === 'ostalo') echo 'selected'; ?>">
    ...
    <main class="container pt-5 ps-md-5">
        <section>
            <div class="row justify-content-center justify-content-md-start">
                <h1 class="text-center text-sm-start text-uppercase"><?php
                                                                        $naziv = $_GET['delatnost'];
                                                                        $new_url = str_replace("-", " ", $naziv);
                                                                        echo $new_url;
                                                                        ?></h1>
    ...
    <!--#region Footer-->
    <footer class="p-4 bg-dark text-white text-center position-relative mt-5">
        <div class="container">
